...
RSpec.describe RollsController, type: :controller do
  ...
  describe "GET #edit" do
    it "returns a success response" do
      roll = Roll.create! valid_attributes
      get :edit, params: {id: roll.to_param}, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the created roll" do
        post :create, params: {roll: valid_attributes}, session: valid_session
        expect(response).to redirect_to(Roll.last)
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "redirects to the roll" do
        ...
        expect(response).to redirect_to(roll)
      end
    end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the rolls list" do
      roll = Roll.create! valid_attributes
      delete :destroy, params: {id: roll.to_param}, session: valid_session
      expect(response).to redirect_to(rolls_url)
    end
  end
